...
def lunar_to_solar_string(lunar_day, lunar_month, lunar_year,
                          lunar_leap_month, viet_language=1, time_zone=7):
    solar_day = lunar_to_solar(lunar_day, lunar_month, lunar_year,
                               lunar_leap_month, time_zone)
    return "{}, {}".format(day_in_week(solar_day[0],
                                       solar_day[1],
                                       solar_day[2],
                                       viet_language),
                           "{}/{}/{}".format(solar_day[0],
    ...
    if lunar_day[3]:
        return "{} - {}/{}/{} AL {}; ngày :{} tháng: {} năm: {}".\
                format(_day_in_week, lunar_day[0], lunar_day[1],
                       lunar_day[2], "nhuận", _zodiac_day, _zodiac_month,
                       _zodiac_year)
    else:
        return "{} - {}/{}/{} AL{}; ngày: {} - tháng: {} - năm: {}".\
                format(_day_in_week, lunar_day[0], lunar_day[1],
